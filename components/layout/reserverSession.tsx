...
export default function ReserverSession() {
                ...
                <motion.div initial={{ opacity: 1, y: -600 }}
                    ...
                    <form action="" className="space-y-6">
                        ...
                        <div className="flex justify-center py-8">
                            <h1 className="text-2xl font-medium text-amber-400">Reserver une session</h1>
                        </div>
                        ...
                        <div className="">
                            <input type="text" className="w-full p-2 text-sm text-gray-300 bg-black border rounded border-amber-200 focus:outline-none" placeholder='Tel' />
                        </div>
                        <div className="">
                            <select name="" id="" className="w-full p-2 text-sm text-gray-300 bg-black border rounded border-amber-200 focus:outline-none">
                                <option value="" className="">Horaires</option>
                            </select>
                        </div>
                        <div className="">
                            <select name="" id="" className="w-full p-2 text-sm text-gray-300 bg-black border rounded border-amber-200 focus:outline-none">
                                <option value="" className="">Offres</option>
                            </select>
                        </div>
